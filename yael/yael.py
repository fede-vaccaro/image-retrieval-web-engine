...
_yael.KEYNULL_swigconstant(_yael)
KEYNULL = _yael.KEYNULL

_yael.IVFCHECKSUM_swigconstant(_yael)
IVFCHECKSUM = _yael.IVFCHECKSUM

_yael.DEFAULT_SEG_SIZE_swigconstant(_yael)
...
class ivfmatch_t(_object):
    ...
    if _newclass:
        qid = _swig_property(_yael.ivfmatch_t_qid_get, _yael.ivfmatch_t_qid_set)
    __swig_setmethods__["bid"] = _yael.ivfmatch_t_bid_set
    __swig_getmethods__["bid"] = _yael.ivfmatch_t_bid_get
    if _newclass:
        bid = _swig_property(_yael.ivfmatch_t_bid_get, _yael.ivfmatch_t_bid_set)
    __swig_setmethods__["score"] = _yael.ivfmatch_t_score_set
    __swig_getmethods__["score"] = _yael.ivfmatch_t_score_get
    if _newclass:
        score = _swig_property(_yael.ivfmatch_t_score_get, _yael.ivfmatch_t_score_set)
...
def bvec_to_numpy_ref(src, ndim):
    """
    bvec _to_numpy(src, shape) -> numpy.ndarray
     shape can be an integer or a tuple of integers (maximum 8 dimentions)
...
def bvec_to_numpy_acquire(src, ndim):
    """
    bvec _to_numpy(src, shape) -> numpy.ndarray
     shape can be an integer or a tuple of integers (maximum 8 dimentions)
...
def fvec_to_numpy_ref(src, ndim):
    """
    fvec _to_numpy(src, shape) -> numpy.ndarray
     shape can be an integer or a tuple of integers (maximum 8 dimentions)
...
def fvec_to_numpy_acquire(src, ndim):
    """
    fvec _to_numpy(src, shape) -> numpy.ndarray
     shape can be an integer or a tuple of integers (maximum 8 dimentions)
...
def ivec_to_numpy_ref(src, ndim):
    """
    ivec _to_numpy(src, shape) -> numpy.ndarray
     shape can be an integer or a tuple of integers (maximum 8 dimentions)
...
def ivec_to_numpy_acquire(src, ndim):
    """
    ivec _to_numpy(src, shape) -> numpy.ndarray
     shape can be an integer or a tuple of integers (maximum 8 dimentions)
...
def int16vec_to_numpy_ref(src, ndim):
    """
    int16vec _to_numpy(src, shape) -> numpy.ndarray
     shape can be an integer or a tuple of integers (maximum 8 dimentions)
...
def int16vec_to_numpy_acquire(src, ndim):
    """
    int16vec _to_numpy(src, shape) -> numpy.ndarray
     shape can be an integer or a tuple of integers (maximum 8 dimentions)
...
def uint16vec_to_numpy_ref(src, ndim):
    """
    uint16vec _to_numpy(src, shape) -> numpy.ndarray
     shape can be an integer or a tuple of integers (maximum 8 dimentions)
...
def uint16vec_to_numpy_acquire(src, ndim):
    """
    uint16vec _to_numpy(src, shape) -> numpy.ndarray
     shape can be an integer or a tuple of integers (maximum 8 dimentions)
...
def dvec_to_numpy_ref(src, ndim):
    """
    dvec _to_numpy(src, shape) -> numpy.ndarray
     shape can be an integer or a tuple of integers (maximum 8 dimentions)
...
def dvec_to_numpy_acquire(src, ndim):
    """
    dvec _to_numpy(src, shape) -> numpy.ndarray
     shape can be an integer or a tuple of integers (maximum 8 dimentions)
